...
*Люблю копаться в чужом коде (иногда даже без исходников) и автоматизировать всё, что движется.*
...
public:
    ...
    void currentlyLearning() {
        std::cout << "Kernel-mode development & Advanced exploitation techniques" << std::endl;
    }
};
```
